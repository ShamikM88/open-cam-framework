# Credit Assessment Memorandum — Asset Finance
...
| Facility # | Facility Type | Asset Type | Credit Line Type | Existing Limit | Proposed Limit | Change | Current Exposure (Exc. RV) | Est. RV % | Max RV Exposure | Max Exposure (Inc. RV) | Est. Max Uncovered Risk |
| :--- | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | [e.g. Finance Lease with RV] | [Asset class] | [Revolving / Term] | | | | | | | | |
| **Total** | | | | | | | | | | | |

## 2. Exposure & Collateral Summary

| Facility # | Asset Description | LGD Grade | Max LGD % | Avg LGD % | Current Exposure (Exc. RV) | RV Exposure | Total Current Exposure | Collateral Cover % | Current Uncovered Risk |
| :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | | | | | | | | | |
| **Total** | | | | | | | | | |

## 3. Credit Ratings / Policy

| PD % | Public Rating (if any) | PD Grade | LGD Grade | Credit Authority | Internal Score (e.g. bureau score) | Credit Policy Exceptions |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| | | | | | | [Detail, or "N/A"] |

*Note the source and date of any external rating referenced (e.g. rating agency, upgrade/downgrade history) and how it maps to internal grading.*

## 4. Facility Conditions — Drawdown Terms, Other Conditions & Additional Security

| Condition | Detail |
| :--- | :--- |
| VAT deferral? | [Yes/No] |
| Pre-settlement clearance allowed? | [Yes/No] |
| Deposit level | [%, amount, or None] |
| Asset type & max age at maturity | [Description / months] |
| Max term | [months] |
| Internal sublet allowed? | [Yes/No] |
| External sublet allowed? | [Yes/No — conditions if Yes] |
| Refinance permitted? | [Yes/No] |
| Corporate guarantees? | [Yes/No — from whom] |
| Personal guarantees? | [Yes/No] |
| Referral to Asset Management required for each drawdown? | [Yes/No] |
| Any non-standard terms? | [Detail, or "None"] |
| MI requirement / covenants? | [Detail] |

## 5. Credit Analyst Recommendation
...
**Source of Introduction:** [Broker / Agency scheme / Direct relationship]
...
| :--- | :--- |
| Customer | [Name] |
| Standard or bespoke asset | [Standard/Bespoke] |
| LGD methodology | [Model / Override / Current collateral] |
| Average LGD approved | [%] |
| Max LGD approved | [%] |
| Average RV % (if applicable) | [%] |
| Collateral cover approved | [%] |
| Asset Management approver | [Name/Role] |
| Date | [Date] |

### Collateral Cover by Asset Class

| Asset Class | Exposure (Rental + RV) | Number of Units | Cap/Model Value | Non-Recovery | Costs | Collateral Value | CV % of Exposure |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| [Asset class 1] | | | | | | | |
| **Total** | | | | | | | |
...
---
*Every fact, figure and rating in this document must be traceable to a verified, credible source (audited financial statements, a recognized credit bureau or rating agency, company filings, or other primary documentation supplied by the user). Where no external score or system integration is available (e.g. no live rating agency feed), the PD/LGD grade is a user-supplied input and must be labelled as such.*
