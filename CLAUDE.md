...
│   ├── policy_engine.py         Deterministic covenant/security/CP/CS evaluation -- evaluate_deal_policy() (no anthropic dependency; see "Maker-Checker agents" and CLAUDE.md's own deterministic-layer notes below)
