...
│   ├── calibrate.md
│   ├── triage.md, spread.md, commercial.md, collateral.md, project.md
│   ├── assemble.md
│   └── review.md
...
│   ├── skills_registry.md       Slash-command registry: /calibrate /triage /spread /commercial /collateral /project /assemble /review
