...
2. Financial Ratios: Calculate TNW, EBITDA, Debt Service Coverage Ratio (DSCR), Gross Leverage, and Working Capital Days. Where these are already provided as pre-calculated ratios in the prompt, use those values directly rather than recalculating them.
